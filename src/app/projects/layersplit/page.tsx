...
export default function LayerSplitProject() {
    return (
        <main className="min-h-screen bg-[#050505] text-white selection:bg-sky-500/30 font-sans">
            ...
            <section className="pt-32 md:pt-48 pb-16 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto relative">
                ...
                <div className="relative z-10 max-w-4xl">
                    <div className="flex items-center gap-3 mb-8">
                        <span className="px-3 py-1.5 rounded-md bg-white/[0.03] border border-white/[0.05] text-[10px] uppercase font-bold tracking-[0.15em] text-white/70">
            ...
            <section className="py-12 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto border-b border-white/[0.05]">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    <div className="space-y-6">
                        <span className="text-sky-200/60 text-[11px] font-mono tracking-widest uppercase mb-4 block">/// Product Overview</span>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-4">
                            <div>
                                <span className="text-white/35 text-[10px] uppercase tracking-[0.15em] font-bold block mb-2">Type</span>
                                <span className="text-white/80 text-sm font-medium">AI-assisted creative utility</span>
                            </div>
                            <div>
                                <span className="text-white/35 text-[10px] uppercase tracking-[0.15em] font-bold block mb-2">Built For</span>
                                <span className="text-white/80 text-sm font-medium">Designers, editors, creators</span>
                            </div>
                            <div className="sm:col-span-2">
                                <span className="text-white/35 text-[10px] uppercase tracking-[0.15em] font-bold block mb-2">Core Output</span>
                                <span className="text-white/80 text-sm font-medium">Foreground, background, and alpha mask bundle</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <span className="text-sky-200/60 text-[11px] font-mono tracking-widest uppercase mb-4 block">/// Build Context</span>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-4">
                            <div>
                                <span className="text-white/35 text-[10px] uppercase tracking-[0.15em] font-bold block mb-2">Status</span>
                                <span className="text-white/80 text-sm font-medium">Active refinement output logic</span>
                            </div>
                            <div>
                                <span className="text-white/35 text-[10px] uppercase tracking-[0.15em] font-bold block mb-2">Problem Solved</span>
                                <span className="text-white/80 text-sm font-medium">Standard tools stop at simple cutouts</span>
                            </div>
                            <div className="sm:col-span-2">
                                <span className="text-white/35 text-[10px] uppercase tracking-[0.15em] font-bold block mb-2">My Role</span>
                                <span className="text-white/80 text-sm font-medium">Product thinking, UI design, frontend execution, workflow logic</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 mt-6 pt-6 border-t border-white/[0.05]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div>
                                ...
                                <span className="text-white/70 text-sm font-medium">Product thinking, UI design, frontend implementation</span>
                            </div>
                            <div>
                                <span className="text-white/30 text-[10px] uppercase tracking-[0.15em] font-bold block mb-1">Stack</span>
                                <span className="text-white/70 text-sm font-medium">React, Next.js, Tailwind CSS, Framer Motion</span>
                            </div>
                            <div>
                                <span className="text-white/30 text-[10px] uppercase tracking-[0.15em] font-bold block mb-1">Focus</span>
                                <span className="text-white/70 text-sm font-medium">Workflow UX, interface clarity, structured product execution</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
                <div className="relative w-full aspect-[16/10] md:aspect-[21/9] rounded-[24px] overflow-hidden bg-[#0A0A0A] border border-white/[0.05] shadow-[0_20px_60px_rgba(0,0,0,0.6)] group">
                    ...
                    <div className="absolute bottom-6 left-8 z-20 flex items-center gap-3">
                        <div className="px-3 py-1.5 rounded-lg bg-black/60 backdrop-blur-md border border-white/10 text-[10px] font-mono tracking-widest text-white/50">
                            UI_OVERVIEW.png
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 text-white/50 font-light text-lg leading-relaxed">
                            ...
                            <p className="pl-4 border-l border-sky-500/30 text-white/70">
                                LayerSplit was built around that gap. <br/>
                                <span className="italic">The idea was simple: don't just remove the background — make the image reusable.</span>
                            </p>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
                        ...
                        {[
                            ...
                            <div key={idx} className="bg-[#0C0C0C] border border-white/[0.04] p-8 rounded-2xl relative z-10 group hover:border-white/10 hover:bg-[#111] transition-all duration-500">
                                <div className="flex justify-between items-start mb-6">
                                    <span className="text-4xl font-light tracking-tighter text-white/20 group-hover:text-white/40 transition-colors font-mono">{step.num}</span>
                                    <span className="text-[10px] uppercase tracking-[0.15em] text-sky-200/50 bg-sky-500/5 px-2.5 py-1 rounded-md border border-sky-500/10">{step.label}</span>
                                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
                    ...
                    <div className="lg:col-span-7 space-y-8">
                        ...
                        <div className="space-y-6 text-white/50 font-light text-lg leading-relaxed">
                            ...
                            <p className="mt-8 p-6 bg-white/[0.01] border border-white/[0.03] rounded-xl text-white/60 italic">
                        ...
                        <div className="bg-[#0C0C0C] border border-white/[0.04] rounded-2xl p-8 sticky top-32">
                            ...
                            <ul className="space-y-5">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-4 border-b border-white/[0.02] pb-4 last:border-0 last:pb-0">
                                        <CheckCircle2 className="w-4 h-4 text-white/20" />
                                        <span className="text-white/70 text-[14px] font-medium">{feat}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
